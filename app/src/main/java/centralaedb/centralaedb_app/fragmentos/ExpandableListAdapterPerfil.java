...
public class ExpandableListAdapterPerfil extends BaseExpandableListAdapter{

    private Context context;
    private HashMap<String, List<String>> comentario;
    private List<String> timeline;


    public ExpandableListAdapterPerfil(Context context, HashMap<String, List<String>> hashMap , List<String> parent){

        this.context = context;
        this.comentario = hashMap;
...
*/
        ...
        TextView childItem = (TextView)view.findViewById(R.id.textViewChild);
